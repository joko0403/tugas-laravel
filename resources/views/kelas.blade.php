...
<head>
    ...
    <title>Kelas - Dashboard Bimbel G109</title>
    ...
    <div class="sidebar w-64 p-5 shadow flex flex-col justify-between">
        <div>
            ...
            <div class="flex items-center mb-6">
                <img src="https://img.icons8.com/external-flatart-icons-flat-flatarticons/64/000000/external-education-education-flatart-icons-flat-flatarticons.png" 
            ...
            <div>
                ...
                <div id="kelasSubmenu" class="submenu">
                    <a href="siswa.html" class="flex items-center p-2 mb-2 text-gray-700 hover:bg-blue-500 rounded">
