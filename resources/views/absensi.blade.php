...
<div class="flex-grow p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-blue-100 p-6 rounded-lg shadow-lg text-center">
            ...
            <button onclick="fetchSiswa('pagi')" class="bg-blue-500 text-white px-4 py-2 rounded shadow hover:bg-blue-600">Pilih</button>
        </div>
        ...
        <div class="bg-yellow-100 p-6 rounded-lg shadow-lg text-center">
            ...
            <button onclick="fetchSiswa('sore')" class="bg-yellow-500 text-white px-4 py-2 rounded shadow hover:bg-yellow-600">Pilih</button>
        </div>
        ...
        <div class="bg-gray-200 p-6 rounded-lg shadow-lg text-center">
            ...
            <button onclick="fetchSiswa('malam')" class="bg-gray-700 text-white px-4 py-2 rounded shadow hover:bg-gray-800">Pilih</button>
        </div>
    </div>
